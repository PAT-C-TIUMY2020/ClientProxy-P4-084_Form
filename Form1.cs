using ClientProxy_P4_084_Form.ServiceReference1;
using System;
...
namespace ClientProxy_P4_084_Form
{
...
ServiceReference1.MatematikaClient();
           ...
           Math.Pow(selisihY, 2));
            ...
            textBox3.Text = "2/2 = " + hasilBagi;
            textBox4.Text = "2x2 = " + hasilKali;
            textBox5.Text = "hasil koordinat = " + jarak;
        }
    }
}
